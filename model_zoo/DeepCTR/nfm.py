...
def NFM(linear_feature_columns, dnn_feature_columns, n_domain, lora_reduce, dnn_hidden_units=(256, 128, 64),
        ...
        dnn_dropout=0, dnn_activation='relu', task='binary', num_experts=4):
    ...
    if num_experts <= 1:
        ...
        dnn_output = MloraMoE(n_domain, dnn_hidden_units, dnn_activation, l2_reg_dnn, dnn_dropout, False, seed=seed,lora_reduce=lora_reduce,num_experts=num_experts)([dnn_input,domain_input_layer])
